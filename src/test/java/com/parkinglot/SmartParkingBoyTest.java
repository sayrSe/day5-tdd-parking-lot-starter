...
class SmartParkingBoyTest {
    ...
    @Test
    void should_park_to_parking_lot_with_more_parking_spaces_when_park_given_a_standard_parking_boy_and_two_parking_lots_with_one_have_more_parking_spaces() {
        // Given
